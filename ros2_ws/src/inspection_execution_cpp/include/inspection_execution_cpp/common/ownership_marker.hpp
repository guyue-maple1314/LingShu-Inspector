...
// 项目与团队锚点标识
inline constexpr const char* kProjectName = "xiaobi-inspection-robot";
...
inline constexpr const char* kStartupBanner =
    "------------------------------------------------------------\n"
    "  小毕机器人巡检系统 | 青岛港湾职业技术学院 灵枢智行团队\n"
    "  XIAOBI Inspection Robot  (c) 2026 qdgw / lszx_byc\n"
    "  著作权所有，授权范围见 LICENSE\n"
    "------------------------------------------------------------";
